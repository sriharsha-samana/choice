...
%>	
	<head>
		...
		function setCheckboxValues()
		{
			...
			var ActiveScreenURL = "/Choice/JSP/DatabaseJSP/DatabaseDataActionsProcess.jsp?tableName="+tableName+"&fieldName="+fieldNameValue+"&fieldCondition="+fieldNameConditionValue;
		...
		function setCheckboxes(responseText)
		{
			...
			for(i=0;i<list.length;i++)
				{	
					...
					var temp = list[i]+"";
					if(temp.trim().toUpperCase() != primaryKey.trim().toUpperCase() && temp.trim().toUpperCase() != autoNumber.trim().toUpperCase())
						{
...
%>
	<body>
		...
		<div id = header1 class = "header1">
			<h4 style="color:#ff6a22">Search Database</h4><br><br>
		</div>
...
<% 		
										...
										for(int i=0;i<TablesList.size();i++)
											...
											String strEachTable = (String)TablesList.get(i);
