...
<%
		...
		String strDatabaseTableName = "usergroups";
...
%>
		<script type="text/javascript">
			...
			function submitData()
			{
				loadAdminActiveScreen('/Choice/JSP/DatabaseJSP/DeleteExistingUserGroupsProcess.jsp?selectedFields='+document.getElementById("selectedFields").value);
			}
		...
		<title>Delete User Groups</title>
	</head>

	<body>
		<div id = Formheader class = "Formheader">
		<h4 style="color:#ff6a22">Delete Existing User Groups</h4><br><br>
		</div>
...
%>	
			<div id="SideNavigatorCommands" class="SideNavigatorCommands">
				<table border="1">
					<th>Select Field</th><th>Name</th><th>Label</th>
<%
...
<%
							...
							String strLabel = resultSetSideNavigator.getString("Value");
%>
