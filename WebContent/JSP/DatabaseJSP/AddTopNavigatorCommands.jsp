...
<%
		...
		strHeader = "Add Top Navigator Commands";
		
		Actions action = new Actions();	
		int count = 0;
		try
		{
		CachedRowSet resultSetCheckAvailableCommands = action.fetchDataFromDB("clienttopnavigator", null, "Name != 'NA'");
...
%>
	...
	<body>
		...
		<div id="Add_Top_Navigator_linksDiv" class="Add_Top_Navigator_linksDiv">
			...
			<form id="Add_Top_Navigator_linksForm" name="Add_Top_Navigator_linksForm" method="POST" action="/Choice/JSP/DatabaseJSP/AddTopNavigatorCommandsProcess.jsp" enctype="multipart/form-data" onsubmit="showProgress();">

				

				<input type="hidden" id="DatabaseTableName" name="DatabaseTableName" value="clienttopnavigator" />
...
<%
		...
		{
			System.out.println("Exception in AddTopNavigatorCommands.jsp::"+e);
%>
