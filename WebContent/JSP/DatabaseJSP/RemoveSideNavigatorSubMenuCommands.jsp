...
<%
		...
		String strDatabaseTableName = "clientsidenavigatorsubmenucommand";
...
%>
		<script type="text/javascript">
			...
			function submitData()
			{
				loadAdminActiveScreen('/Choice/JSP/DatabaseJSP/RemoveSideNavigatorSubMenuCommandsProcess.jsp?selectedFields='+document.getElementById("selectedFields").value);
			}
	...
	<body>
		...
		<h4 style="color:#ff6a22">Remove Side Navigator Sub-Menu Commands</h4><br><br>
		</div>
...
%>	
			<div id="TopNavigatorCommands" class="TopNavigatorCommands">
				<table border="1">
					<th>Select Field</th><th>Name</th><th>Label</th><th>Link</th><th>Parent Menu</th>
<%
...
<%
							...
							String strMenuName = resultSetTopNavigator.getString("MenuName");
%>
