...
%>
	...
	<h4 style="color:#ff6a22">Table: <%=strTableName%></h4><br><br>
...
%>							
								<tr>	
									<td>
										Number of new entries <input type="number" id="NoOfNewEntries" name="NoOfNewEntries" min="0" value="0" onchange="AddNewFields(<%=rows %>,<%=columns %>);"/>
									</td>
								</tr>
					</table>
					...
					<script>
					 	...
					 	AddNewFields(<%=rows %>,<%=columns %>);
							...
							<input type="button" name="Update" id="Update" value="Update entries" style="width: 125px; height: 30px" onclick="UpdateExistingEntry(<%=rows %>);" />
							<input type="button" name="Delete" id="Delete" value="Delete entries" style="width: 125px; height: 30px" onclick="DeleteExistingEntry(<%=rows %>);" />
							<input type="button" name="Add" id="Add" value="Add new entries" style="width: 125px; height: 30px" onclick="AddNewEntry();" />
