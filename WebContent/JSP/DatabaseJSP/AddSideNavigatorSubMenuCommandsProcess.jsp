	...
	try
		{
			...
			strNames[4]= "MenuName";
			strTempValue = m.getParameter("MenuName");
			strTempValue = strTempValue.trim();
			strValues[4]= strTempValue;
			strTempValue = m.getParameter("MenuNameDatabaseTableFieldName");
			strTempValue = strTempValue.trim();
...
%>
					<script type="text/javascript">
						alert("New Command added to Side Navigator Sub-Menu Succesfully!");
...
%>
							<script type="text/javascript">
								alert("Command with same name already exists!!");
								window.open("/Choice/AdminHome.jsp","_top");
							</script>
<%
						}
...
<%
			...
			{
				System.out.println("Exception in AddTopNavigatorLinksProcess.jsp ::"+e);
%>
