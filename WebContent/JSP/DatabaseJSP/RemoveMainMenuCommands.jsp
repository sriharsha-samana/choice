...
<%
		...
		String strDatabaseTableName = "clientmainmenu";
...
%>
		<script type="text/javascript">
			...
			function submitData()
			{
				loadAdminActiveScreen('/Choice/JSP/DatabaseJSP/RemoveMainMenuCommandsProcess.jsp?selectedFields='+document.getElementById("selectedFields").value);
			}
	...
	<body>
		...
		<h4 style="color:#ff6a22">Remove Main Menu Commands</h4><br><br>
		</div>
