...
<%
		...
		String strDatabaseTableName = "clientsidenavigator";
...
%>
		<script type="text/javascript">
			...
			function submitData()
			{
				loadAdminActiveScreen('/Choice/JSP/DatabaseJSP/RemoveSideNavigatorCommandsProcess.jsp?selectedFields='+document.getElementById("selectedFields").value);
			}
	...
	<body>
		...
		<h4 style="color:#ff6a22">Remove Side Navigator Commands</h4><br><br>
		</div>
...
%>	
			<div id="SideNavigatorCommands" class="SideNavigatorCommands">
				<table border="1">
					<th>Select Field</th><th>Name</th><th>Label</th><th>Link</th><th>Menu/Command</th>
<%
...
%>
						<tr>
<%
							String strName = resultSetSideNavigator.getString("Name");
							String strLabel = resultSetSideNavigator.getString("Label");
							String strLink = resultSetSideNavigator.getString("Link");
							String strIsMenu = resultSetSideNavigator.getString("IsMenu");
							if(strIsMenu.equalsIgnoreCase("true"))
							{
								strIsMenu = "Menu";
							}
							else
